...
public sealed class CreateChaptersCommand(
    ...
    FixItemsEncodingCommand fixItemsEncodingCommand) : CommandBase
{
    protected override Task<IResponse<object>> Command(object? parameter)
    {
        var viewModel = new CreateChaptersViewModel(mediaFilesContainer.Files, fixItemEncodingCommand, fixItemsEncodingCommand);
