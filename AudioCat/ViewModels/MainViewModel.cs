...
public sealed class MainViewModel : IConcatParams, INotifyPropertyChanged
{
    ...
    private enum ChaptersSourceType { None, AutoGenerated, CreatedByWizard }
...
#pragma warning disable S107
    ...
    private async Task AddOutputChaptersOnStartup(Task _)
    {
        ...
        try
        {
            foreach (var newChapter in ChaptersFactory.CreateFromExisting(Files, false)) // TODO: Settings.TrimStartingNonChars
                await Application.Current.Dispatcher.InvokeAsync(() => OutputChapters.Add(newChapter));
            OutputChaptersSource = ChaptersSourceType.AutoGenerated;
